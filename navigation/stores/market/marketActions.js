...
export const GET_COIN_MARKET_BEGIN = "GET_HOLDINGS_BEGIN"
export const GET_COIN_MARKET_SUCCESS= "GET_HOLDINGS_SUCCESS"
export const GET_COIN_MARKET_FAILURE = "GET_HOLDINGS_FAILURE"
...
oderBy = "market_cap_desc", sparkline = true, priceChangePerc = "7d",
perPage = 10, page = 1) {
            ...
            if(response.status == 200) {
                let myHoldings = response.data.map((item) => {
                    ...
                    return {
                        ...
                        holding_value_change_7d: (items.current_price
                            - priced7d) * coin.qty,
                            sparkline_in_7d: {
...
"market_cap_desc", sparkline = true, priceChangePerc = "7d", perPage
= 10, page = 1 ){
